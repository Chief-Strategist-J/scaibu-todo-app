...
class EmptyCacheException implements Exception {
  ...
  /// The message detailing the exceptions cause.
...
class CacheRefreshException implements Exception {
  ...
  /// Converts the exceptions to a readable string format.
  @override
...
class ResponseParseException implements Exception {
  /// Initializes the exceptions with a message, response body,
  ...
  /// The cause of the exceptions, if available.
  final dynamic cause;
...
class MaxRetriesException implements Exception {
  /// Initializes the exceptions with a message and a list of errors.
  ...
  /// Converts the exceptions to a readable string format, including
...
class InvalidUrlException implements Exception {
  /// Initializes the exceptions with a message and an optional cause.
  ...
  /// Converts the exceptions to a readable string format, including the
  /// cause if present.
  @override
  String toString() =>
...
class NetworkException implements Exception {
  /// Initializes the exceptions with a message.
...
class ApiException implements Exception {
  /// Initializes the exceptions with a status code, message, and optional data.
  ...
  /// Optional data related to the exceptions, if available.
  final dynamic data;

  /// Converts the exceptions to a readable string
