...
_$TodoProjectModelImpl _$$TodoProjectModelImplFromJson(
        Map<String, dynamic> json) =>
    _$TodoProjectModelImpl(
...
Map<String, dynamic> _$$TodoProjectModelImplToJson(
        _$TodoProjectModelImpl instance) =>
    <String, dynamic>{
      'uuid': instance.uuid,
      'name': instance.name,
      'slug': instance.slug,
